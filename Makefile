...
PROJECT_REPO ?= github.com/drneo-mehdi/provider-github
...
export TERRAFORM_PROVIDER_VERSION ?= 6.2.1
export TERRAFORM_PROVIDER_DOWNLOAD_NAME ?= terraform-provider-github
export TERRAFORM_PROVIDER_DOWNLOAD_URL_PREFIX ?= terraform-provider-github
export TERRAFORM_NATIVE_PROVIDER_BINARY ?= terraform-provider-github_v6.2.1
